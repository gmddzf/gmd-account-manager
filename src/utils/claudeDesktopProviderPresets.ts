...
const ALL_CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESETS: readonly ClaudeDesktopGatewayProviderPreset[] = [
  {
    id: CLAUDE_DESKTOP_GATEWAY_APIKEY_FUN_PROVIDER_ID,
    name: 'GMD API',
    baseUrls: [APIKEY_FUN_GLOBAL_ENDPOINT],
    authScheme: 'bearer',
    connectionMode: 'direct',
    website: APIKEY_FUN_REGISTER_URL,
  ...
  },
  {
    ...
    apiKeyUrl: 'https://sssaicodeapi.com',
    isPartner: true,
    modelMappings: directRoutes(),
  },
  {
  ...
  },
  {
    ...
    apiKeyUrl: 'https://www.micuapi.ai',
    isPartner: true,
    modelMappings: directRoutes(),
  },
  {
  ...
  },
  {
    ...
    apiKeyUrl: 'https://code.pipellm.ai',
    modelMappings: directRoutes(),
  },
];

export const CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESETS: readonly ClaudeDesktopGatewayProviderPreset[] =
  ALL_CLAUDE_DESKTOP_GATEWAY_PROVIDER_PRESETS.filter(isGmdCustomerProviderPreset);
