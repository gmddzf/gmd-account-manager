import { isGmdCustomerProviderPreset } from './gmdProviderVisibility';
...
export const GMD_API_PROVIDER_ID = "gmd_api";
export const GMD_API_PROVIDER_NAME = "GMD API";
// Kept for accounts created by older Cockpit builds. It is intentionally not
// a customer default and has no fixed endpoint in the GMD build.
export const COCKPIT_API_PROVIDER_ID = "cockpit_api";
export const COCKPIT_API_PROVIDER_NAME = "API";
...
const COCKPIT_API_HIDDEN_BASE_URLS: readonly string[] = [];

const ALL_CODEX_API_PROVIDER_PRESETS: readonly CodexApiProviderPreset[] = [
  {
    id: "openai_official",
...
export const CODEX_API_PROVIDER_PRESETS: readonly CodexApiProviderPreset[] =
  ALL_CODEX_API_PROVIDER_PRESETS.filter(isGmdCustomerProviderPreset);
