...
const ALL_CLAUDE_API_PROVIDER_PRESETS: readonly ClaudeApiProviderPreset[] = [
  {
    id: CLAUDE_APIKEY_FUN_PROVIDER_ID,
    name: 'GMD API',
    baseUrls: [CLAUDE_APIKEY_FUN_BASE_URL],
...
export const CLAUDE_API_PROVIDER_PRESETS: readonly ClaudeApiProviderPreset[] =
  ALL_CLAUDE_API_PROVIDER_PRESETS.filter(isGmdCustomerProviderPreset);
