...
import { GMD_UPDATER_ENABLED } from '../utils/gmdProduct';
...
import {
  Save, FolderOpen, CircleHelp,
  AlertCircle, RefreshCw, FileText, Download, X
} from 'lucide-react';
import gmdLogo from '../assets/brand/gmd-logo.jpg';
        ...
        {activeTab === 'general' && (
          ...
          >
            ...
            <div className="settings-group">
              ...
              <div className="settings-row" data-tour="tutorial-setting">
                <div className="row-label">
                  <div className="row-title">
                    {t('settings.general.openTutorial', '新手教程')}
                  </div>
                  <div className="row-desc">
                    {t('settings.general.openTutorialDesc', '重新查看 GMD 账号管理的主要功能和操作路径。')}
                  </div>
                </div>
                <div className="row-control">
                  <button
                    type="button"
                    className="btn btn-secondary"
                    onClick={() => window.dispatchEvent(new Event('gmd-open-onboarding'))}
                  >
                    <CircleHelp size={16} />
                    {t('settings.general.openTutorialAction', '开始教程')}
                  </button>
                </div>
              </div>
...
<div style={{ order: platformSettingsOrder.grok }}>
        ...
        {activeTab === 'network' && (
          <>
            <div className="group-title">GMD API 服务</div>
            <div className="settings-group">
              <div className="settings-row">
                <div className="row-label">
          ...
          <div className="about-container">
            ...
            <div className="credits-list">
              <div className="credit-item">
                <div className="credit-icon"><img src={gmdLogo} alt="GMD" className="settings-credit-logo" /></div>
                <h3>GMD 账号管理</h3>
                <p>客户版 · 本地数据优先</p>
              </div>
              <div className="credit-item">
                <div className="credit-icon"><span aria-hidden="true">GMD</span></div>
                <h3>GMD API</h3>
                <p>统一的模型账号与 API 管理</p>
              </div>
              <div className="credit-item">
                <div className="credit-icon"><CircleHelp size={24} /></div>
                <h3>客户支持</h3>
                <p>请通过你的 GMD 客服渠道联系</p>
              </div>
            </div>
          </div>
        )}
