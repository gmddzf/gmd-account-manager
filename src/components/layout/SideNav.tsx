...
const APP_DISPLAY_NAME = 'GMD 账号管理';
...
export function SideNav({
  ...
  return (
    <>
      ...
      <div className="nav-brand" ref={brandRef} style={{ position: 'relative', zIndex: 10 }} data-tour="brand">
        ...
        {sidebarMenuEntries.map((entry) => {
          ...
          return (
            <button
              ...
              title={entry.label}
              data-tour={
                entry.kind === 'api-relay'
                  ? 'api-relay-nav'
                  : entry.targetPlatformId === 'codex'
                    ? 'codex-nav'
                    : undefined
              }
            >
