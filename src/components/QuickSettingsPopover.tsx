  ...
  const codexQuickPresetOptions = useMemo(
    () => [
      ...
      },
      {
        ...
        label: t('quickSettings.codex.quickConfig.preset272kShort', '272K 费用保护'),
        desc: t(
          'quickSettings.codex.quickConfig.preset272kDesc',
              ...
              <div className="qs-section">
                ...
                <div className="qs-hint">
                  {t(
                    ...
                    '重启 Codex 实例后，在输入框下方显示 GMD 账号管理 API 服务的账号数、周额度和 5h 额度。需保持 GMD 账号管理 在后台运行；完全退出或网络不可用时，额度不会继续刷新。',
                  )}
                </div>
                {isWindows && (
                  <>
